	 ...
	 QUẢN LÝ KHÁC HÀNG
		...
		:10px;">
			...
			<div class="col-md-4 col-xs-5">
				 <img  title="Tạo mã khác" style="margin-top:1px;"  src="<?=base_url()?>authorize/captcha/543534.html" id="icaptcha">
			</div>
			<div class="col-md-2 reloadCaptcha" style="text-align:right;">
        ...
        <div class="form-group clearfix" >
			<div class="row">
			    <div class="col-md-12" style="margin-top:10px; ">
					<button id="login" type="submit" class="btn blue" style="padding:5px; height:36px;">
