...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption caption2">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('hang-xe');?></div>			
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_c.manufacturer_name"><?=getLanguage('hang-xe')?></th>
								<th></th>
								<th></th>
							</tr>
						</table>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="manufacturer_name" id="manufacturer_name" class="searchs form-control " />
								</td>
								</td><td>
								</td><td>
							</tr>
...
<script>
	...
	var cpage = 0;
	var search;
	var hxkdt = "<?=getLanguage('hang-xe-khong-duoc-trong');?>";
	$(function(){
		init();
		refresh();
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var manufacturer_name = $('.manufacturer_name').eq(e).html().trim();
				 var id = $(this).attr('id');
				 $('#id').val(id);	
