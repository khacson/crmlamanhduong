...
<table border="0" width="100%" >
	<tr >
    	<td colspan="2" align="center">
			<div style="font-size:26px; font-weight:600;">PHIẾU THU</div>
			<div style="margin-top:0px; margin-bottom:30px;">(<?=$datas->receipts_code;?>)</div>
		</td>
    </tr>
	<tr>
    	<td>Lý do thu: <?=$type;?> <?php if(!empty($datas->notes)){?><?=$datas->notes;?><?php }?>
