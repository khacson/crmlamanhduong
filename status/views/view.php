...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('trang-thai');?></div>		
		</div>
		<div class="tools">
...
<script>
	...
	function save(){
		...
		if(obj.status_name == ''){
			warning('Trạng thái không được trống'); return false;	
		}
		var token = $('#token').val();
		$('.loading').show();
		$.ajax({
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 ...
				 var status_name = $('.status_name').eq(e).html().trim();
