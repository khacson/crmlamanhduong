...
<div class="portlet box blue mtop0">
	<div class="portlet-title">
		<div class="caption caption2">
			 <div class="brc mtop3"><i class="fa fa-bars"></i> <?=getLanguage('tim-thay');?> <span class="semi-bold viewtotal">0</span> <?=getLanguage('hang-bao-hiem');?></div>			
		</div>
		<div class="tools">
					...
					<div id="tHeader">    	
						<table id="tbheader" width="100%" cellspacing="0" border="1" >
							...
							<tr>							
								...
								<th id="ord_c.insurance_code"><?=getLanguage('ma-hang-bh');?></th>
								<th id="ord_c.insurance_name"><?=getLanguage('ten-hang-bh');?></th>
								<th></th>
								<th></th>
							</tr>
						</table>
					...
					<div id="gridView">
						<table id="tbbody" width="100%" cellspacing="0" border="1">
							...
							<tr class="row-search">
								...
								<td></td>
								<td>
									<input type="text" name="insurance_code" id="insurance_code" class="searchs form-control " />
								</td>
								<td>
									<input type="text" name="insurance_name" id="insurance_name" class="searchs form-control " />
								</td>
								</td><td>
								</td><td>
							</tr>
...
<script>
	...
	var cpage = 0;
	var search;
	var ttkdt = "<?=getLanguage('ten-hang-khong-duoc-trong');?>";
	$(function(){
		init();
		refresh();
	...
	function searchFunction(){
		$("#insurance_name,#insurance_code,#registrationstation_phone,#registrationstation_address").keyup(function() {
			searchList();	
		});
	}
    ...
    function funcList(obj){
		$('.edit').each(function(e){
			$(this).click(function(){ 
				 var insurance_name = $('.insurance_name').eq(e).html().trim();
				 var id = $(this).attr('id');
				 $('#id').val(id);	
