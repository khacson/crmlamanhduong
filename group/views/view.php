					...
					<div id="tHeader">    	
						<table width="100%" cellspacing="0" border="1" >
							...
							<tr>
								...
								<th id="ord_g.companyid"><?=getLanguage('khach-hang');?></th>
							...
							<tr class="row-search">
								...
								<td>
									<select name="grouptype"  class="combos" id="grouptype">
										<option value=""></option>
										<option value="1"><?=getLanguage('admin');?></option>
										<option value="2"><?=getLanguage('nhan-vien');?></option>
									</select>
								</td>
								<td>
									<select name="companyid"  class="combos" id="companyid">
...
<script>
	...
	function refresh(){
		$(".loading").show();
		$(".searchs").val("");
		$('#grouptype,#companyid').multipleSelect('uncheckAll');
		csrfHash = $('#token').val();
		search = getSearch();
