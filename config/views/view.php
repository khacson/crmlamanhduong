		...
		<!--<div class="row mtop10">
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-7">
						<select id="cfso" name = "cfso" class="combos ">
							<option value=""></option>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-7">
						<select id="cfse" name = "cfse" class="combos ">
							<option value=""></option>
							<option value="0">Tự động phát sinh</option>
							<option value="1">Nhân viên nhập</option>
						</select>
				...
				<legend class="legend ">Phiếu nhập kho</legend>
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" name="cfpn" id="cfpn" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								<select id="cfpn_type" name = "cfpn_type" class="combos ">
									<option value=""></option>
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" maxlength="6" name="cfpn_default" id="cfpn_default" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
			</fieldset>
				...
				<legend class="legend">Phiếu xuất kho</legend>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Ký tự bắt đầu</label>
							<div class="col-md-7">
								<input type="text" name="cfpx" id="cfpx" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Định dạng</label>
							<div class="col-md-7">
								<select id="cfpx_type" name = "cfpx_type" class="combos ">
									<option value=""></option>
									<option value="0">Tăng theo năm tháng</option>
									<option value="1">Tăng theo số thứ tự</option>
								</select>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Giá trị khởi tạo</label>
							<div class="col-md-7">
								<input type="text" maxlength="6" name="cfpx_default" id="cfpx_default" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
			</fieldset>
				...
				<legend class="legend">Tạo đơn bán hàng</legend>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Ký tự bắt đầu</label>
							<div class="col-md-7">
								<input type="text" name="cfdh" id="cfdh" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Định dạng</label>
							<div class="col-md-7">
								<select id="cfdh_type" name = "cfdh_type" class="combos ">
									<option value=""></option>
									<option value="0">Tăng theo năm tháng</option>
									<option value="1">Tăng theo số thứ tự</option>
								</select>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Giá trị khởi tạo</label>
							<div class="col-md-7">
								<input type="text" maxlength="6" name="cfdh_default" id="cfdh_default" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
			</fieldset>
				...
				<legend class="legend">Phiếu thu</legend>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Ký tự bắt đầu</label>
							<div class="col-md-7">
								<input type="text" name="cfpt" id="cfpt" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Định dạng</label>
							<div class="col-md-7">
								<select id="cfpt_type" name = "cfpt_type" class="combos ">
									<option value=""></option>
									<option value="0">Tăng theo năm tháng</option>
									<option value="1">Tăng theo số thứ tự</option>
								</select>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Giá trị khởi tạo</label>
							<div class="col-md-7">
								<input type="text" maxlength="6" name="cfpt_default" id="cfpt_default" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
				...
				<legend class="legend">Phiếu chi</legend>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Ký tự bắt đầu</label>
							<div class="col-md-7">
								<input type="text" name="cfpc" id="cfpc" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Định dạng</label>
							<div class="col-md-7">
								<select id="cfpc_type" name = "cfpc_type" class="combos ">
									<option value=""></option>
									<option value="0">Tăng theo năm tháng</option>
									<option value="1">Tăng theo số thứ tự</option>
								</select>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-md-5">Giá trị khởi tạo</label>
							<div class="col-md-7">
								<input type="text" maxlength="6" name="cfpc_default" id="cfpc_default" placeholder="" class="searchs form-control " />
							</div>
						</div>
					</div>
			</fieldset>
			...
			<fieldset class="fieldset">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="col-md-7">
							<select id="iscn" name = "iscn" class="combos ">
								<option value=""></option>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="col-md-7">
							<select id="isreceipt" name = "isreceipt" class="combos ">
								<option value=""></option>
				...
				<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-7">
								<select id="ispay" name = "ispay" class="combos ">
									<option value=""></option>
									<option value="0">Nhân viên thanh toán</option>
									<option value="1">Tự động thanh toán</option>
								</select>
		...
		<div class="row mtop10">
			<fieldset class="fieldset">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<select id="cfdate" name = "cfdate" class="combos ">
							<option value=""></option>
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-7">
						<select id="cfnumber"  name = "cfnumber"  class="combos ">
							<option value=""></option>
			...
			<div class="col-md-4" style="display:none;">
				<div class="form-group">
					...
					<div class="col-md-7">
						<select id="isguarantee" name = "isguarantee" class="combos ">
							<option value=""></option>
			...
			<div class="col-md-4 mtop10" style="display:none;">
				<div class="form-group">
					...
					<div class="col-md-7">
						<select id="isserial" name = "isserial" class="combos ">
							<option value=""></option>
							<option value="0">Không sử dụng</option>
							<option value="1">Có sử dụng</option>
						</select>
			...
			<div class="col-md-4 mtop10" style="display:none;">
				<div class="form-group">
					...
					<div class="col-md-7">
						<select id="cksp" name = "cksp" class="combos ">
							<option value=""></option>
							<option value="0">Không sử dụng</option>
							<option value="1">Có sử dụng</option>
						</select>
		...
		$.ajax({
			...
			success:function(datas){
				...
				if(obj.status == 0){
					...
					window.location = "<?=base_url();?>authorize/logout";
					return false;
				}
			},
			error : function(){
				error('<?=getLanguage('edit_failed')?>'); return false;	
			}
		});
	}
	function init(){
