...
<script>
	...
	function searchFunction(){
		$("#car_number,#car_cavet_name,#customer_name,#customer_phone,#presenter_name,#presenter_phone").keyup(function() {
			searchList();	
		});
	}
	...
	function save(){
		...
		//box_images
		var objectfile2 = document.getElementById('box_images').files;
		var length2 = objectfile2.length; 
		for (var i = 0; i < length2; i++) {
			data.append('box_images' + i, objectfile2[i]);
		}
		data.append('length2', length2);
